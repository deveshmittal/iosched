...
package app.traceindia.covid.client.android.model.userdata

import app.traceindia.covid.client.android.model.SessionId
import app.traceindia.covid.client.android.model.reservations.ReservationRequest
import app.traceindia.covid.client.android.model.reservations.ReservationRequest.ReservationRequestEntityAction.CANCEL_REQUESTED
import app.traceindia.covid.client.android.model.reservations.ReservationRequest.ReservationRequestEntityAction.RESERVE_REQUESTED
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_CUTOFF
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_DENIED_UNKNOWN
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.CANCEL_SUCCEEDED
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CLASH
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_CUTOFF
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_DENIED_UNKNOWN
...
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.RESERVE_WAITLISTED
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CLASH
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_CUTOFF
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_DENIED_UNKNOWN
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_SUCCEEDED
import app.traceindia.covid.client.android.model.reservations.ReservationRequestResult.ReservationRequestStatus.SWAP_WAITLISTED
