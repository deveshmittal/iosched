...
import app.traceindia.covid.client.android.R.style
import app.traceindia.covid.client.android.databinding.FragmentSessionDetailBinding
...
import app.traceindia.covid.client.android.shared.di.MapFeatureEnabledFlag
import app.traceindia.covid.client.android.shared.domain.users.SwapRequestParameters
import app.traceindia.covid.client.android.shared.notifications.AlarmBroadcastReceiver
...
import app.traceindia.covid.client.android.ui.prefs.SnackbarPreferenceViewModel
import app.traceindia.covid.client.android.ui.reservation.RemoveReservationDialogFragment
import app.traceindia.covid.client.android.ui.reservation.RemoveReservationDialogFragment.Companion.DIALOG_REMOVE_RESERVATION
import app.traceindia.covid.client.android.ui.reservation.RemoveReservationDialogParameters
import app.traceindia.covid.client.android.ui.reservation.SwapReservationDialogFragment
import app.traceindia.covid.client.android.ui.reservation.SwapReservationDialogFragment.Companion.DIALOG_SWAP_RESERVATION
import app.traceindia.covid.client.android.ui.schedule.ScheduleFragmentDirections.Companion.toSessionDetail
import app.traceindia.covid.client.android.ui.sessiondetail.SessionDetailFragmentDirections.Companion.toSpeakerDetail
import app.traceindia.covid.client.android.ui.setUpSnackbar
import app.traceindia.covid.client.android.ui.signin.NotificationsPreferenceDialogFragment
import app.traceindia.covid.client.android.ui.signin.NotificationsPreferenceDialogFragment.Companion.DIALOG_NOTIFICATIONS_PREFERENCE
import app.traceindia.covid.client.android.ui.signin.SignInDialogFragment
import app.traceindia.covid.client.android.ui.signin.SignInDialogFragment.Companion.DIALOG_SIGN_IN
import app.traceindia.covid.client.android.util.doOnApplyWindowInsets
import app.traceindia.covid.client.android.util.openWebsiteUrl
import app.traceindia.covid.client.android.util.postponeEnterTransition
...
class SessionDetailFragment : MainNavigationFragment(), SessionFeedbackFragment.Listener {
    ...
    override fun onCreateView(
        ...
        sessionDetailViewModel.navigateToYouTubeAction.observe(viewLifecycleOwner, EventObserver { youtubeUrl ->
            openYoutubeUrl(youtubeUrl)
        })

        sessionDetailViewModel.navigateToSessionAction.observe(viewLifecycleOwner, EventObserver { sessionId ->
        ...
        sessionDetailViewModel.navigateToSignInDialogAction.observe(viewLifecycleOwner, EventObserver {
            openSignInDialog(requireActivity())
        })
        sessionDetailViewModel.navigateToRemoveReservationDialogAction.observe(viewLifecycleOwner, EventObserver {
            openRemoveReservationDialog(requireActivity(), it)
        })
        sessionDetailViewModel.navigateToSwapReservationDialogAction.observe(viewLifecycleOwner, EventObserver {
            openSwapReservationDialog(requireActivity(), it)
        })

        sessionDetailViewModel.shouldShowNotificationsPrefAction.observe(viewLifecycleOwner, EventObserver {
            if (it) {
                openNotificationsPreferenceDialog()
            }
        })

        sessionDetailViewModel.navigateToSpeakerDetail.observe(viewLifecycleOwner, EventObserver { speakerId ->
        ...
        sessionDetailViewModel.navigateToSessionFeedbackAction.observe(viewLifecycleOwner, EventObserver {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        sessionDetailViewModel.shouldShowStarInBottomNav.observe(viewLifecycleOwner, Observer { showStar ->
            showStar?.let {
                if (it) {
