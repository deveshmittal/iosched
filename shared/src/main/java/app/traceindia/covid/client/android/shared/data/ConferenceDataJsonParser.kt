...
import app.traceindia.covid.client.android.model.SessionType
import app.traceindia.covid.client.android.model.SessionType.KEYNOTE
import app.traceindia.covid.client.android.model.SessionType.SESSION
import app.traceindia.covid.client.android.model.Speaker
import app.traceindia.covid.client.android.model.Tag
import app.traceindia.covid.client.android.shared.data.session.json.CodelabDeserializer
import app.traceindia.covid.client.android.shared.data.session.json.CodelabTemp
import app.traceindia.covid.client.android.shared.data.session.json.RoomDeserializer
import app.traceindia.covid.client.android.shared.data.session.json.SessionDeserializer
import app.traceindia.covid.client.android.shared.data.session.json.SessionTemp
import app.traceindia.covid.client.android.shared.data.session.json.SpeakerDeserializer
import app.traceindia.covid.client.android.shared.data.session.json.TagDeserializer
