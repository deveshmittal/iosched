...
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_REQUEST_ACTION_KEY
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_REQUEST_KEY
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_REQUEST_REQUEST_ID_KEY
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_RESULT_KEY
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_RESULT_REQ_ID_KEY
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_RESULT_RESULT_KEY
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_RESULT_TIME_KEY
import app.traceindia.covid.client.android.shared.data.userevent.FirestoreUserEventDataSource.Companion.RESERVATION_STATUS_KEY
