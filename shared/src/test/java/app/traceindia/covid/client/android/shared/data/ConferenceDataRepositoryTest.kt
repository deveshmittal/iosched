...
import app.traceindia.covid.client.android.test.data.TestData.session1
import app.traceindia.covid.client.android.test.data.TestData.session3
import app.traceindia.covid.client.android.test.util.FakeAppDatabase
